...
struct i2c_master_module i2c_master_instance;
static struct i2c_master_packet packet = {KTD2026_DEVICE_ADDRESS,
DATA_LENGTH_PRIMARY};
...
void i2c_master_setup(void) {
        ...
        i2c_master_get_config_defaults(&config_i2c_master);
        config_i2c_master.buffer_timeout = 10000;
        i2c_master_init(&i2c_master_instance, MASTER_MODULE,
&config_i2c_master); i2c_master_enable(&i2c_master_instance);
}
